...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#chudenghiencuu">Chủ đề nghiên cứu</a></li>
  <li><a data-toggle="tab" href="#linhvuclienquan">Lĩnh vưc</a></li>
</ul>


<div class="tab-content">
	<div id="chudenghiencuu" class="tab-pane active">
	
		<h2>Các chủ đề nghiên cứu</h2>
	...
	<div id="linhvuclienquan" class="tab-pane">
		...
		<hr />
		<div id="chonlinhvuc">
			<h3>Tích chon các lĩnh vực liên quan</h3>
			<div id="linhvuc">
			</div>
		</div>
